...
export const RocketLaunchButton = () => {
  ...
  const shouldDisplayButton =
    !isRocketMoving && isTripStarted && !isTripFinished && isJoruenyModeActive;
