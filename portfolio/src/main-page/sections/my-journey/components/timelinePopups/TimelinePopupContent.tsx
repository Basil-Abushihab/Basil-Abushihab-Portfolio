...
export const TimelinePopupContent = (props: TimeLinePopupProps) => {
  ...
  return (
    <motion.div animate={animationVariant} className="flex flex-col w-full h-full max-h-[460px] no-scrollbar overflow-y-scroll gap-4 bg-white rounded-3xl p-10 text-black font-satoshi lg:max-h-[600px]">
